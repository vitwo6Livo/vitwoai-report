...
class Vendorwise extends ConsumerWidget {
  const Vendorwise({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                data.content[index].vendorName.toString(),
                                    ...
                                    child: Text.rich(
                                      TextSpan(
                                        ...
                                        children: [
                                          TextSpan(
                                            text: data
                                                .content[index].receivedQuantity
                                                .toString(),
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall!
