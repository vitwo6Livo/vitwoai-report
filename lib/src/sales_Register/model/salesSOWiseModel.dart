class SalesSOwisemodel {
  final List<SalesSOContentList> content;
...
class SalesSOContentList {
  ...
  factory SalesSOContentList.fromJson(Map<String, dynamic> json) {
    String _toString(dynamic value) => value != null ? value.toString() : '';

    return SalesSOContentList(
      soNumber: _toString(json['SO Number']),
      soDate: _toString(json['SO Date']),
