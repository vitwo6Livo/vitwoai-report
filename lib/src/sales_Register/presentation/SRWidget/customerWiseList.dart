...
class CustomerWiseScreen extends ConsumerWidget {
  const CustomerWiseScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final salesRegisterCustomerWiseList =
        ref.watch(salesRegisterCustomerProvider);
    return Scaffold(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                data['content'][index]['Customer Name'],
