...
class newSRItemGWiseDetailsScreen extends StatelessWidget {
  List<SalesItemGroupContentList> data;
  int index;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          HandText.srItemWiseDetailsTitle,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildSection(HandText.srItemGW_ItemInfo, [
              _buildTile("Item Group Name", item.itemGroupName),
            ]),
            _buildSection(HandText.srItemGWQtyVal, [
            ...
            _buildSection(HandText.srItemGWTaxAmt, [
