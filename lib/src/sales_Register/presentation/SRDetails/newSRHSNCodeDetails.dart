...
class newSRHsnCodeWiseDetailsScreen extends StatelessWidget {
  List<SalesHSNCodeContentList> data;
  int index;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          HandText.srHSNWiseDetailsTitle,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildSection(HandText.srHSNItemDetails, [
            ...
            _buildSection(HandText.srHSNTaxAmt, [
