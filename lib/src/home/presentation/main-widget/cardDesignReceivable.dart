...
class CardDesignReceivable extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    final List<List<dynamic>> chartData = [
      [40, 'Total Due', Colors.blue],
      [30, 'Amount Due', Colors.green],
      [20, 'Net Due', Colors.orange],
    ];
    return Card(
      color: Colors.white,
      elevation: 4,
